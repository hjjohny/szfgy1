...
A Model végzi a játék működéséhez elengedhetetlen számításokat. A View-val a ViewModelen keresztül áll kapcsolatban, tőle kapja az üzeneteket, a View a ViewModelen keresztül kérdezi le a játék állását.

\subsubsection{``Game'' osztály}
